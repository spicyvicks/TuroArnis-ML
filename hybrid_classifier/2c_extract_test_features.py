"""
Step 2c: Generate Node-Specific + Hybrid Features (TEST SET ONLY)
- Clone of 2b but processes ONLY the test dataset.
- Used for quick evaluation without reprocessing training data.
"""
...
def process_dataset(viewpoint_filter=None, num_workers=None):
    """Process ONLY TEST images and generate node + hybrid features"""
    # Load templates
