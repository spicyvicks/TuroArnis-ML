...
NODE_EMBED_DIM = 8
CLASS_NAMES = [
    'neutral', 'stick_left_side', 'stick_right_side',
    'stick_left_shoulder', 'stick_right_shoulder',
    'stick_left_arm', 'stick_right_arm',
    'stick_left_leg', 'stick_right_leg',
    'stick_left_hand', 'stick_right_hand',
    'stick_both_hands', 'stick_special'
]
